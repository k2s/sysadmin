...
docker build . -t deltachat-android --no-cache > ~/build.log && docker run --name ndk-make-$date -v $(pwd):/home/app -w /home/app deltachat-android ./ndk-make.sh >> ~/build.log && docker run --rm -v $(pwd):/home/app -w /home/app deltachat-android ./gradlew assembleDebug --stacktrace >> ~/build.log
